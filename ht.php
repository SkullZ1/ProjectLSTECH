            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item" style="margin-left: -20px;">
                        <a class="nav-link active" href="tips.php">Tutorial</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="card-body shadow p-3 mb-5 bg-white rounded">
                    ...
                    <h5 class="card-title font-weight-bold">Apa itu HTML? </h5>
                    <p class="card-text">Mari kita lihat pengertian HTML menurut wikipedia:</p>
                    <blockquote>
                        <p>HTML atau <em>HyperText Markup Language</em> merupakan sebuah bahasa
                            <a href="https://kbbi.web.id/markah" target="_blank"><em>markah</em><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="11" height="10" viewBox="0 0 11 10" aria-label="External Link" style="margin:0 .15rem"><polygon fill="#00ad9f" points="12 5.038 6.962 10.066 5.668 8.772 8.502 5.961 0 5.961 0 4.116 8.502 4.116 5.691 1.282 6.984 0" transform="rotate(-40 6 5.033)"></polygon></svg></a>                            untuk membuat halaman web. <sup id="fnref:1"><a href="#fn:1" class="footnote-ref" role="doc-noteref">1</a></sup></p>
                    </blockquote>
                    <p class="card-text">Jadi, HTML itu adalah <strong><i>sebuah bahasa</i></strong> yang menggunakan markup atau penanda untuk <strong><i>membuat halaman web.</i></strong></p>
                    <p class="card-text">Penanda atau markup ini, nanti akan kita sebut dengan <strong>Tag</strong>.
                    </p>
                    <p class="card-text">HTML berperan untuk menentukan struktur konten dan tampilan dari sebuah web.</p>
                    <p class="card-text">Kalau kita ibaratkan nih..</p>
                    <p class="card-text">HTML itu seperti batu bata untuk membangun rumah. Batu bata ini dapat disusun, hingga menjadi fondasi dasar.</p>

                    <img src="css/images/html-css-js.png" class="img-fluid" alt="Responsive image"></img><br>
                    ...
                    <ul>
                        <li><a href="css.html">Tutorial CSS</a></li>
                        <li><a href="js.html">Tutorial Javascript</a></li>
                    </ul>

                    <h5 class="card-title font-weight-bold">Peralatan untuk Belajar HTML </h5>
                    <p class="card-text">Adapun peralatan yang harus kamu persiapkan adalah:</p>
                    <p class="font-weight-bold">1. Teks Editor untuk Menulis HTML</p>
                    <p class="card-text">Teks editor akan kita gunakan untuk menulis kode-kode HTML. Kamu bebas menggunakan teks editor apapun.</p>

                    <img src="css/images/notepadpp.png" class="img-fluid" alt="Responsive image"></img><br>

                    <p class="card-text">Apapun teks editornya, yang penting bisa digunakan untuk membuat dan menulis dokumen HTML.</p>
                    <p class="font-weight-bold">2. Web Browser untuk Membuka HTML</p>
                    <p class="card-text">Web browser akan kita gunakan untuk membuka HTML. Kamu juga bebeas menggunakan web browser apapun.</p>

                    <img src="css/images/web-browser.png" class="img-fluid" alt="Responsive image"></img><br>

                    <p class="card-text">Saran saya sih.. gunakan web browser yang terbaru, karena kita juga akan menggunakan HTML versi yang terbaru..</p>

                    <br>
                    <h5 class="card-tittle font-weight-bold">Membuat Dokumen HTML Pertamamu</h5>
                    <p class="card-text">
...
&lt;<span style="color:#ff79c6">html</span> <span style="color:#50fa7b">lang</span><span style="color:#ff79c6">=</span><span style="color:#f1fa8c">"en"</span>&gt;
    &lt;<span style="color:#ff79c6">head</span>&gt;
        &lt;<span style="color:#ff79c6">title</span>&gt;Belajar HTML #01&lt;/<span style="color:#ff79c6">title</span>&gt;
    &lt;/<span style="color:#ff79c6">head</span>&gt;
    &lt;<span style="color:#ff79c6">body</span>&gt;
        &lt;<span style="color:#ff79c6">p</span>&gt;Hello World!&lt;/<span style="color:#ff79c6">p</span>&gt;
    &lt;/<span style="color:#ff79c6">body</span>&gt;
&lt;/<span style="color:#ff79c6">html</span>&gt;
                    ...
                    <br>
                    <p class="card-text">
                        Setelah itu, simpan dengan nama <code style="color:#fc4db0 ;">hello-world.html.</code>
                    </p>
                    <P class="card-text">Sekarang cobalah buka file hello-world.html dengan web browser. maka hasilnya :</P>

                    <img src="css/images/hello-world-html.png" class="img-fluid" alt="Responsive image"></img><br>
            ...
            <div class="col-sm-4">
                <div class="list-group ">
                    <a href="ht.php" class=" grid list-group-item list-group-item-action active">
                        <div class="row">
                            <div class="col-12">
